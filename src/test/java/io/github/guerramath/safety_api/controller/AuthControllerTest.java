...
public class AuthControllerTest {
    ...
    @BeforeEach
    void setUp() {
        testUser = JwtTestUtils.createTestPilot();
        testUser.setId(1L);
    }
    ...
    void testGetCurrentUser() throws Exception {
        // Arrange
        String bearerToken = JwtTestUtils.generateBearerToken(testUser);
    ...
    @Test
    @DisplayName("Deve retornar 401 ao acessar /auth/me sem token")
